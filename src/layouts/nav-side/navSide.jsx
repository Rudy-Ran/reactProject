...
const NavSide = props =>{
    let subMenuSelected = props.history.location.pathname.split("/")[1];
    return(
        <div style={{ height: '32px', background: 'rgba(255,255,255,.2)', margin: '16px' }}>
        <Menu theme="dark" mode="inline" defaultSelectedKeys={[props.location.pathname]} defaultOpenKeys={[subMenuSelected]}>
